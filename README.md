...
已上线：[https://47.93.230.221/ai-learning/](https://47.93.230.221/ai-learning/)。当前发布 ID 为 `atlas-20260909-r8`。
...
网页文字统一使用 -apple-system / BlinkMacSystemFont / PingFang SC 等本地系统无衬线字体。首页标题采用 200 轻字重、柔和明亮层次与响应式换行，参考苹果锁屏时间的视觉气质；其他页面保留正常阅读字重。非苹果设备使用系统回退字体。原 Instrument Serif 字体文件保留归档，不再注册加载；11 张封面图片保持原样。
