...
已上线：[https://47.93.230.221/ai-learning/](https://47.93.230.221/ai-learning/)。当前发布 ID 为 `atlas-20260909-r5`。
...
- 已在用户现有 Google Chrome 中复现并修复跨页点击报错，实际验证首页进入目录、目录切章、进入第 2 章、切换练习页、下一章到第 3 章、返回地图保留章节、分类选择第 9 章、切换至第 11 章及点击海报进入课程。测试后浏览器停在第 1 章的二级目录；未改写练习笔记或完成记录。未执行全尺寸视觉回归测试。
